...
#define _BL 0 //Base Layer: Macos layer
#define _WL 1 //Base layer: Windows layer
...
[_WL] = LAYOUT_ansi(
  ...
  MO(_FL), KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT,         KC_ENT,KC_MNXT,  \
  KC_LSFT,         KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,   KC_RSFT,KC_UP,KC_MPLY, \
  KC_LCTL, KC_LGUI,KC_LALT,                KC_SPC,                        KC_SLK,MO(_FL),KC_OTRM, KC_LEFT,KC_DOWN,KC_RGHT),
...
[_FL] = LAYOUT_ansi(
  ...
  _______,DF(_BL),_______,DF(_WL),_______,_______,_______,_______,_______,_______,_______,_______,        _______,KC_VOLU, \
